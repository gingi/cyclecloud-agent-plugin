...
import { createCycleCloudClient, type CycleCloudClient } from "./cyclecloud-client.js";
...
export async function requirePluginEnvironment(environment: Readonly<Record<string, string | undefined>>): Promise<PluginEnvironment> {
...
export async function startFromCommandLine(environment: Readonly<Record<string, string | undefined>> = process.env): Promise<void> {
